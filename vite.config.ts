...
// Carregado com fs em vez de `import ... from`: em alguns hosts (Vercel,
// Render) a pasta oculta `.figma/` pode não ter sido enviada ao repositório
// Git (pastas com "." na frente às vezes são ignoradas por uploads via
// interface web). Com fs, o build não quebra se o arquivo não existir —
// só usa um objeto vazio, e os metadados (título, favicon, etc.) do Figma
// Make deixam de ser aplicados, sem impedir o deploy.
...
function figmaSiteConfiguration(config: FigmaSiteConfiguration): Plugin {
  ...
  const title = config.title ?? "Vida+Saúde"
