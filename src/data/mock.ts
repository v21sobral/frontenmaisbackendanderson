...
export interface SysUser {
  ...
  name: string;
  email: string;
  role: "admin" | "attendant" | "doctor" | "patient";
  active: boolean;
  password: string;
  patientId?: number;
  doctorId?: number;
...
export const sysUsers: SysUser[] = [
  ...
  { id: 3, name: "Dr. Rafael Mendes", email: "medico@vidamaissaude.com", role: "doctor", active: true, password: "medico123", doctorId: 1 },
  { id: 4, name: "Dra. Fernanda Lima", email: "fernanda@vidamaissaude.com", role: "doctor", active: true, password: "fernanda123", doctorId: 2 },
